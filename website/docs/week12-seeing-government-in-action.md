---
sidebar_position: 14
sidebar_label: "Week 12: Seeing Government in Action"
title: "Week 12: Seeing Government in Action"
description: "Learn how citizens interact with local government — from attending meetings to writing letters and speaking up."
---
...
1. Choose a topic the student cares about (could be real or made up): a new playground, longer recess, a stop sign at a dangerous corner, more books in the library.

2. Have them plan a 2-minute statement:
...
3. Have them deliver it out loud. Time them.
...
You can also use [C-SPAN Classroom](https://www.c-span.org/classroom/) to watch clips of Congress in action.
...
:::info Unit 3 Wrap-Up: Name the Final Mental Model
You've now completed Unit 3 — Your Local Government. Add the fifth and final mental model:

5. **Participation Keeps Communities Healthy** — A community that nobody maintains eventually breaks down. Voting, speaking up, and serving are how citizens keep the system working.
...
- Your **state representative** (find them at [USA.gov](https://www.usa.gov/elected-officials) — if the link has changed, search "find my elected officials" at usa.gov)
...
2. **Who you are:** "My name is [name], and I am a [age]-year-old student in [city/town]."
3. **Your concern or idea:** "I am writing because..."
4. **Your reasoning:** "This matters because..."
5. **Your request:** "I would like to ask you to consider..."
6. **A closing:** "Thank you for your time. Sincerely, [Your name]"
