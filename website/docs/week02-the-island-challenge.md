---
sidebar_position: 4
sidebar_label: "Week 2: The Island Challenge"
title: "Week 2: The Island Challenge"
description: "Students design rules for a brand-new community from scratch, discovering why cooperation requires shared agreements."
---
...
1. **At least 5 rules** that address important needs (food, shelter, safety, fairness, decisions).
2. **A decision-making process** — how will the group settle disagreements?
3. **One rule about what happens if someone breaks a rule.**
