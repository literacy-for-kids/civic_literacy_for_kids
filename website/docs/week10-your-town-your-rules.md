---
sidebar_position: 12
sidebar_label: "Week 10: Your Town, Your Rules"
title: "Week 10: Your Town, Your Rules"
description: "Explore local government — mayors, city councils, and school boards — and discover how decisions are made in your own community."
---
...
- Bookmark [Ben's Guide: Local Government](https://bensguide.gpo.gov/) for background.
...
1. **What type of local government do you have?** (City, town, county, village?)
2. **Who is the mayor or top leader?** (What is their name?)
3. **How many council members are there?** (What are their names, if you can find them?)
4. **When does the council meet?** (Day, time, and location — it's almost always open to the public.)
5. **What's one issue they've discussed recently?** (Check the city website for meeting agendas or minutes.)
6. **How much is the annual budget?** (An approximate number is fine.)
