---
sidebar_position: 11
sidebar_label: "Week 9: Elections and Voting"
title: "Week 9: Elections and Voting"
description: "Discover how elections work, why voting matters, and how the right to vote expanded over time — making 'Power Flows from the People' real."
---
...
- Bookmark [Ben's Guide to the U.S. Government — Voting & Elections](https://bensguide.gpo.gov/) for background.
- Bookmark [iCivics: "Cast Your Vote"](https://www.icivics.org/) for a free voting-related game (optional extension).
...
Each candidate gives a 1-minute "speech" (the facilitator reads both, or two students present them, or the student reads one and the facilitator reads the other).
...
1. **The position** — What job is being elected? What does this person do?
2. **Two candidates** — Give each one a name and a platform (what they promise to do). Make sure both sides have real strengths.
3. **Campaign materials** — Create a short speech OR a campaign poster for each candidate.
4. **Voting rules** — How will people vote? (Secret ballot? Show of hands? Ranked choice?) Who counts the votes?
5. **The vote** — If you have family members or friends available, run the actual election. If not, write out what you think would happen and why.
6. **Fairness check** — Answer: "Is this election fair? What could make it unfair? How would you prevent cheating?"
