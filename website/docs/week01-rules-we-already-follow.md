...
- Bookmark [iCivics: "Rules and Laws"](https://www.icivics.org/) for optional exploration.
:::
...
1. **Draw a poster** showing the most important rules of that place and write one sentence explaining *why* each rule exists.
2. **Invent a new rule** for that place. Write or draw what the rule is, what problem it solves, and why it's fair.
3. **Write about a rule you would change.** Explain the current rule, why you think it could be better, and what your improved version would look like.
...
:::tip Learning Moment
Civic ideas make more sense after a teach-back. Try: "This rule exists because ___, and an example is ___." If the example is hard to explain, that is the part to practice next.
