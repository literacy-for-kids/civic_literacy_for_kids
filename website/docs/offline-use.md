...
Every lesson in the Civic Literacy curriculum can be run with no technology beyond a printed page.
...
**Discussion prompts:** Read aloud from the printed lesson or from the [Exit Ticket Bank](exit-ticket-bank.md).
